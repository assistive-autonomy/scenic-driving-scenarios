...
_KWARGS_DESCRIPTION = """
Args:
    model (model): model used for calculating Perplexity
    ...
    tokenizer (tokenizer or None): tokenizer
Returns:
...
class PerplexityWithLocalModel(evaluate.Metric):
    def _info(self):
    ...
    def _compute(
        self, predictions, model, tokenizer, batch_size: int = 16, add_start_token: bool = True, max_length=None
    ):
